% solution of d^2u/dx^2 = k*u(constant) for neumann boundary conditions
...
f = createF(n, phi_array, x, phi_0, fx, x1, x2, k);
...
function [f] = createF(n, phi_array, x, phi_0, fx, x1, x2, k)
